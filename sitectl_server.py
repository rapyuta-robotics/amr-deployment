...
GWM_CORE_URL = os.environ.get("GWM_CORE_URL", "http://192.168.10.202:8000")
TOKEN = os.environ.get('TOKEN', 'autobootstrap')
...
GWM_INTERFACE_ENDPOINT_HOST = os.environ.get('GWM_INTERFACE_ENDPOINT_HOST', '192.168.10.202').rstrip('/')
